					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tshirt" data-toggle="tab">Android</a></li>
								<li><a href="#blazers" data-toggle="tab">IOS</a></li>
								<li><a href="#sunglass" data-toggle="tab">Windows</a></li>
								<li><a href="#kids" data-toggle="tab">Mac</a></li>
