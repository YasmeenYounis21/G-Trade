						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
                                ...
                                <?php 
											...
											echo '</button>';
			                                echo '
			                                    <button type="button" class="btn btn-fefault compare" onclick="javascript:ajaxCall('. get_the_ID() .')">
			                                        <i class="fa" style="padding-right:5px">
			                                            Add to Comparison List
			                                        </i>
			                                    </button>';
			                                echo '<div id="msg"></div>';
			                                echo do_shortcode('[add_to_compare_product_list]');
											echo '</span>';
											echo '<p>';
											echo '<b>';
											echo 'Availability: ';
											...
											echo 'Storage: ';
											echo '</b>';
											echo get_post_meta(get_the_ID(),'storage', true);
											echo '</p>';
